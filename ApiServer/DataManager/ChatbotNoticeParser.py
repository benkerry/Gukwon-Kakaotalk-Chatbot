...
def run(logger):
    str_url = "http://school.cbe.go.kr/gukwon-h/M010406/list?s_idx="
    ...
    with open("data/ChatbotNotice.dat", 'w', encoding='utf-8') as fp:
        for i in lst_result:
            fp.write(i[0] + '\n')
            fp.write(i[1] + '\n')
            fp.write('http://school.cbe.go.kr' + i[2] + '\n')

    logger.log("Chatbot Notice Parsing Complete.")
