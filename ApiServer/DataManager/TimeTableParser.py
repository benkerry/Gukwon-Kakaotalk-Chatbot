    ...
    for week_index in range(1, 8):
        ...
        for grade in range(1, 4):
            for _class in range(1, 13):
                ...
                try:
                    for i in range(1, len(dict_json['this_week']['자료14'][grade][_class][week_index])):
                        teacher_index = dict_json['this_week']['자료14'][grade][_class][week_index][i] // 100
                        subject_index = dict_json['this_week']['자료14'][grade][_class][week_index][i] % 100
    ...
    for week_index in range(1, 8):
        ...
        for grade in range(1, 4):
            for _class in range(1, 13):
                ...
                dict_result[str_key['datetime']][str_key['grade-class']] = []
                try:
                    for i in range(1, len(dict_json['next_week']['자료14'][grade][_class][week_index])):
                        teacher_index = dict_json['next_week']['자료14'][grade][_class][week_index][i] // 100
                        subject_index = dict_json['next_week']['자료14'][grade][_class][week_index][i] % 100
