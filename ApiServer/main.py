...
def redirect():
    return "<script>location.href='" + config.location + "';</script>";
...
mailer.send('Server Starting...', '...', ['developer_kerry@kakao.com'])
