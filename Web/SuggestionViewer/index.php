<html>
    ...
    <body>
        <div class='description'>
            <button class='toggleIssue' id='btnOpen' onclick='setOpen();' style='display:none;'> 열린 제안 보기</button>
            <button class='toggleIssue' id="btnClose" onclick='setClosed();'> 닫힌 제안 보기</button>
            <div id='divOpen'>
                <!-- Open Issues -->
